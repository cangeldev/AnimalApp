...
export const BackgroundPaw = require("./images/backgroundPaw.png");
export const ProfileSelected = require("./images/profileSelected.png");
export const Profile = require("./images/profile.png");
export const HutSelected = require("./images/hutSelected.png");
